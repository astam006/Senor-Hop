add wave -noupdate -divider {lcd_display_CPU: top-level ports}
...
add wave -noupdate -divider {lcd_display_CPU: base pipeline}
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/clk
add wave -noupdate -format Logic -radix hexadecimal /NIOS2_INSTANCE_TOP/reset_n
...
add wave -noupdate -divider {lcd_display_CPU: multicycle_custom_instruction}
