...
--synthesis_resources = 
 ...
 ENTITY  lcd_display_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END lcd_display_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF lcd_display_rsp_xbar_demux_002 IS
 ...
 END RTL; --lcd_display_rsp_xbar_demux_002
