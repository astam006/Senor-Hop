...
--synthesis_resources = 
 ...
 ENTITY  lcd_display_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 sink_valid	:	IN  STD_LOGIC_VECTOR (5 DOWNTO 0);
 ...
 END lcd_display_cmd_xbar_demux;

 ARCHITECTURE RTL OF lcd_display_cmd_xbar_demux IS
 ...
 END RTL; --lcd_display_cmd_xbar_demux
